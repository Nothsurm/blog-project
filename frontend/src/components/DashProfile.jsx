...
export default function DashProfile() {
    ...
    const uploadImage = async () => {
        // Console Firebase Storage Rules Tab
        ...
        const fileName = new Date().getTime() + imageFile.name //so each file name is unique
    ...
    <div className="max-w-lg mx-auto p-3 w-full">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4"> 
            ...
            onClick={() => filePickerRef.current.click()}>
                ...
                <img 
                    src={imageFileUrl || currentUser.profilePicture || 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png'} referrerPolicy="no-referrer"
                    alt="user"
